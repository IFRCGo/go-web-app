...
type ActivityFormField = NonNullable<PlannedInterventionFormFields['early_action_activities']>[number];
        ...
        >
            <ListView layout="block">
                <ListView layout="grid" numPreferredGridColumns={3}>
                    <TextInput
                        label={strings.operationReadiness}
                        name="activity"
                    ...
                    {value?.timeframe && (
                        <Checklist
                            label={strings.operationTimeValue}
                            name="time_value"
