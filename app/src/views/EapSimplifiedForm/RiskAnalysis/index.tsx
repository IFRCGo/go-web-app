                ...
                >
                    <ListView layout="block">
                        ...
                        <TextOutput
                            ...
                            value={(
                                <ul>
                                    <li>{strings.riskSectionCriteriaComment11}</li>
                                    <li>{strings.riskSectionCriteriaComment12}</li>
                                    <li>{strings.riskSectionCriteriaComment13}</li>
                                </ul>
                            )}
                            strongLabel
                            withoutLabelColon
                        ...
                        <TextOutput
                            ...
                            value={(
                                <ul>
                                    <li>{strings.riskSectionCriteriaComment2}</li>
                                </ul>
                            )}
                            strongLabel
                            withoutLabelColon
                        ...
                        <TextOutput
                            ...
                            value={(
                                <ul>
                                    <li>{strings.riskSectionCriteriaComment31}</li>
                                    <li>{strings.riskSectionCriteriaComment32}</li>
                                    <li>{strings.riskSectionCriteriaComment33}</li>
                                </ul>
                            )}
                            strongLabel
                            withoutLabelColon
                        ...
                        <TextOutput
                            ...
                            value={(
                                <ul>
                                    <li>{strings.riskSectionCriteriaComment4}</li>
                                </ul>
                            )}
                            strongLabel
                            withoutLabelColon
