        ...
        <TabPage spacingOffset={-6}>
            <InlineLayout
                after={(
                    ...
                    >
                        {strings.activationSectionCriteriaButtonLabel}
                    </Button>
                )}
            />
            ...
            {showQualityCriteria && (
                ...
                >
                    <ListView layout="block">
                        <TextOutput
                            label={strings.activationSectionCriteriaIntroduction1}
                            value={strings.activationSectionCriteriaComment1}
                            strongLabel
                            valueType="text"
                            withoutLabelColon
                        />
                        <TextOutput
                            label={strings.activationSectionCriteriaIntroduction2}
                            value={strings.activationSectionCriteriaComment2}
                            strongLabel
                            valueType="text"
                            withoutLabelColon
                        />
                        <TextOutput
                            label={strings.activationSectionCriteriaIntroduction3}
                            value={strings.activationSectionCriteriaComment3}
                            strongLabel
                            valueType="text"
                            withoutLabelColon
                        />
