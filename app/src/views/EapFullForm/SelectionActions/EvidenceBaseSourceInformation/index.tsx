...
function EvidenceBaseSourceInformationInput(props: Props) {
    const {
    ...
    return (
        <>
            ...
            <TextInput
                label={strings.eapFullEvidenceSourceInformationNameLabel}
                name="source_name"
            ...
            />
            <TextInput
                label={strings.eapFullEvidenceSourceInformationLinkLabel}
                name="source_link"
            ...
            <Button
                ...
                title={strings.eapFullEvidenceSourceInformationDeleteButton}
            >
...
export default EvidenceBaseSourceInformationInput;
