...
type SourceInformationFormFields = NonNullable<PartialEapFullFormType['trigger_model_source_of_information']>[number];
...
function SourceInformationInput(props: Props) {
    ...
    return (
        <>
            ...
            <TextInput
                label={strings.eapFullFormSourceInformationNameLabel}
                name="source_name"
            ...
            />
            <TextInput
                label={strings.eapFullFormSourceInformationLinkLabel}
                name="source_link"
            ...
            <Button
                ...
                title={strings.eapFullFormSourceInformationDeleteButton}
            >
