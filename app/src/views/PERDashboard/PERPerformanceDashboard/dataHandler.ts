...
function getComponentRatings(
    ...
    componentGroups.forEach((_, componentId) => {
    ...
    return {
        ...
        } as unknown as ComponentRatingsResult['overallRating'],
        ...
        }) as unknown as ComponentRatingsResult['areaData'],
        ...
        }) as unknown as ComponentRatingsResult['componentData'],
    };
}
