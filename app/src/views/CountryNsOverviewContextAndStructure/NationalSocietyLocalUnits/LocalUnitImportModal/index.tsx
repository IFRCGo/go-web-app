            ...
            <ListView layout="block">
                ...
                {!pending && (
                    <InlineLayout
                        ...
                        withPadding
                    >
                        Please be aware that this action will replace all
                        the existing local units of selected type! To avoid
                        potential loss of data, please make sure to export the local units!
                    </InlineLayout>
                )}
            </ListView>
        </Modal>
