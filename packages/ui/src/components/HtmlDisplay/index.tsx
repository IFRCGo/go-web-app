...
/**
 * Renders a string of sanitized HTML into a `<div>` (raw layer).
 *
 * The value is sanitized before being set as inner HTML. There is no
 * `value` attribute / value-output treatment here: the rendered content
 * is rich markup, not a single formatted value.
 */
function HtmlDisplay(props: Props) {
    const {
        className,
        value,
        ...otherProps
    ...
    return (
        <div
            ...
            {...otherProps}
            className={_cs(styles.htmlDisplay, className)}
