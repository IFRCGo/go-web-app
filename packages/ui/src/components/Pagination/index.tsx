...
/**
 * Pagination is a specific component for page-based navigation, built on
 * RawButton. Rendered as a `<nav>` landmark with the active page marked
 * `aria-current="page"`.
 */
function Pagination(props: Props) {
    ...
    return (
        <nav
            className={_cs(className, styles.pagination)}
