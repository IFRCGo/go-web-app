...
export type { Props as InlineFrameProps } from './components/InlineFrame';
export { default as InlineFrame } from './components/InlineFrame';
...
export type { Props as KeyFigureViewProps } from './components/KeyFigureView';
export { default as KeyFigureView } from './components/KeyFigureView';
export type { Props as LabelProps } from './components/Label';
