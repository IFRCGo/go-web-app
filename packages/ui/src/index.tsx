...
export type { Props as BaseProps } from './components/TextOutput';
export type { Props as BooleanProps } from './components/TextOutput';
export type { Props as DateProps } from './components/TextOutput';
export type { Props as NodeProps } from './components/TextOutput';
export type { Props as TextProps } from './components/TextOutput';
