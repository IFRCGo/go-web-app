import { TruncatedListProps } from '@ifrc-go/ui';
import type {
    Meta,
    StoryObj,
...
type TruncatedListSpecificProps = TruncatedListProps<Option, RendererProps>;

type Story = StoryObj<TruncatedListSpecificProps>;
