...
export function Component() {
    ...
    const handleBackButtonClick = useCallback(() => {
        goBack(generatePath(catalogueCommunityEngagementRoute.absolutePath));
    }, [goBack, catalogueCommunityEngagementRoute.absolutePath]);
    ...
    return (
        ...
        >
            ...
            >
                <ul>
                    <li>
                        {strings.ceaDesignedForListItemOne}
                    </li>
                    <li>
                        {strings.ceaDesignedForListItemTwo}
                    </li>
                    <li>
                        {strings.ceaDesignedForListItemThree}
                    </li>
                    <li>
                        {strings.ceaDesignedForListItemFour}
                    </li>
                    <li>
                        {strings.ceaDesignedForListItemFive}
                    </li>
                </ul>
            </Container>
            <Container
...
Component.displayName = 'CommunityEngagement';
