...
export function Component() {
    ...
    const {
        informationTechnologyServices: informationTechnologyServicesRoute,
    ...
    const emergencyResponseData: LinkData[] = [
        {
            ...
            to: generatePath(informationTechnologyServicesRoute.absolutePath),
...
Component.displayName = 'CatalogueInformationTechnologyIndex';
